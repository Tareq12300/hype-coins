...
class Detector:
    ...
    async def add_trade(self, trade: Trade) -> None:
        ...
        async with self.lock:
            ...
            first_price = trades_1m[0].price
            last_price = trades_1m[-1].price
            ...
            avg_minute_volume, volume_spike_x, volume_change_pct, baseline_samples = self.volume_spike(key, total)
    ...
    async with aiohttp.ClientSession(timeout=timeout, connector=connector) as session:
        ...
        if STARTUP_MESSAGE:
            await telegram.send(
                ...
                f"متوسط الفوليوم: <b>آخر {VOLUME_BASELINE_MINUTES} دقيقة مكتملة</b>"
            )
